...
An Anime Themed group management bot with useful features. [ㅤ](https://telegra.ph/file/fed9ba09e9add9b197c21.png)
...
def main():
    ...
    if WEBHOOK:
        ...
        if MESSAGE_DUMP:
            updater.bot.send_message(chat_id=MESSAGE_DUMP, text="I'm The Cute Marin Bot...")
